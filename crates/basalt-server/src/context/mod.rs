//! Production runtime implementation of basalt-api's Context trait.
//!
//! [`ServerContext`] is the per-dispatch context object used by the game
//! loop and net tasks. It implements basalt-api's [`Context`] trait and
//! all sub-context traits, delegating block ops to the inner
//! `Arc<World>` and queueing deferred responses for the runtime to
//! process after handler dispatch completes.
